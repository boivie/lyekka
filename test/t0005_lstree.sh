...
test_expect_success 'listing simple tree' '
  (
    ...
    lyekka lstree -i a548d2e141f8759f53a29207fbbb2d4a5471ef54bfd88fd406896559b5071c86 > actual &&
...
test_expect_success 'listing more advanced tree' '
  (
    ...
    lyekka lstree -i 0b11700c7c58fb8ca5b57b4273bfd1c3e4c48646f77280f6469f28b749b3f2ab > actual &&
    test_cmp expected actual 
  )'
